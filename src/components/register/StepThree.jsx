            ...
            <div className='grid md:grid-cols-2 gap-6 mt-5'>
                ...
                <div>
                    ...
                    >
                        ...
                        <option value='SENSORES REMOTOS'>{translates.interest_product_2}</option>
                        <option value='CARTOGRAFÍA'>{translates.interest_product_3}</option>
                        <option value='GEOPROCESAMIENTO'>{translates.interest_product_4}</option>
                        <option value='TOPOGRAFÍA 3D'>{translates.interest_product_5}</option>
                        <option value='INTELIGENCIA ARTIFICIAL'>{translates.interest_product_6}</option>
                        <option value='MONITOREO E INSPECCIONES'>{translates.interest_product_7}</option>
                        <option value='NAVEGACIÓN Y POSICIONAMIENTO'>{translates.interest_product_8}</option>
                        <option value='ESCANEO LASER Y LIDIAR'>{translates.interest_product_9}</option>
                        <option value='CATASTRO MULTIPROPÓSITO'>{translates.interest_product_10}</option>
                    </select>
